...
public class WriteAndReadFileProductCSV {
    ...
    public static void writeFile(ArrayList<Product> productArrayList) {
        FileWriter fileWriter = null;
        try {
            fileWriter = new FileWriter("src/collection_framework_arraylist/Product.csv");
    ...
    public static ArrayList<Product> readFile() {
        ...
        Path path = Paths.get("src/collection_framework_arraylist/Product.csv");
        if (!Files.exists(path)) {
            try {
                FileWriter fileWriter = new FileWriter("src/collection_framework_arraylist/Product.csv");
            } catch (Exception exception) {
        ...
        try {
            String line;
            br = new BufferedReader(new FileReader("src/collection_framework_arraylist/Product.csv"));
